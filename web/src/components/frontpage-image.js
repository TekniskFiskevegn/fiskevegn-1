...
import { responsiveTitleBig } from "../components/typography.module.css";
      ...
      <div className={styles.frontpageImage}>
        {frontpageImage.caption && (
          <div className={styles.caption}>
            <h2 className={cn(responsiveTitleBig, styles.captionText)}>{frontpageImage.caption}</h2>
            <svg viewBox="0 0 1400 770">
