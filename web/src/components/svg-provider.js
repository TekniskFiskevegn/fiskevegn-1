...
const wave = (shapeNumber, shapePosition = "bottom") => {
  const customClass = cn(styles.wave, shapePosition === "top" ? styles.waveTop : styles.waveBottom);

  switch (shapeNumber) {
    case "1":
      return (
        <svg className={customClass} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path
            fill="#F3F4F5"
            fillOpacity="1"
